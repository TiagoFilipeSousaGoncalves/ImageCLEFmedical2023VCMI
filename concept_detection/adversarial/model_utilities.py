...
class ConceptDiscriminator(torch.nn.Module):
    def __init__(self, input_size):
        super(ConceptDiscriminator, self).__init__()
        ...
        # Create FC1 Layer for classification
        self.fc1 = torch.nn.Linear(in_features=int(self.input_size), out_features=int(self.input_size/5))
        self.relu1 = torch.nn.ReLU()

        self.fc2 = torch.nn.Linear(in_features=int(self.input_size/5), out_features=int(self.input_size/(5*5)))
        self.relu2 = torch.nn.ReLU()

        self.fc3 = torch.nn.Linear(in_features=int(self.input_size/(5*5)), out_features=1)
