...
if __name__ == "__main__":
  ...
  # Ground-truth file
  # Data directory
  parser.add_argument('--ground_truth_path', type=str, required=True, help="Ground-truth file path.")

  # Model
  parser.add_argument("--submission_file_path", type=str, required=True, help="Submission file path.")
